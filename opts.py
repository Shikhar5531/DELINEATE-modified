...
# -----------------------------
# Paths (SET DEFAULTS HERE)
# -----------------------------
#parser.add_argument('--checkpoint_path', type=str, default=r"E:\DELINEATE\dil-Unet\checkpoints\\")

#parser.add_argument('--data_path', type=str, default=r"E:\DELINEATE\dil-Unet\datasets")

#parser.add_argument('--load_from_checkpoint', type=str, default=r"E:\DELINEATE\dil-Unet\checkpoints_combined_data\model-4920")
